...
Contact :: Contact(std::string f_name, std::string l_name, std::string n_name, std::string p_bumber, std::string d_secret )
	{
		first_name = f_name;
		last_name = l_name;
		nickname = n_name;
...
void	PhoneBook::print_contacts() {
	for (int i = 0; i < contact_count; ++i) {
		...
		std::cout << std::setw(10) << std::right << truncateString(contacts[i].getNickname(),10) << " | ";
		std::cout << std::setw(10) << std::right << truncateString(contacts[i].getPhone(),10) << " | ";
		std::cout << std::setw(10) << std::right << truncateString(contacts[i].getSecret(),10) << std::endl;
